...
L.Control.Boating = L.Control.extend({
  ...
  request: function () {
    ...
    ackee.action("337c625d-2834-4354-8807-c2728614cbed", {
      key: "nav",
      value: 1,
    });
  },
  ...
  updateLine: function (e) {
    ...
    const length =
      (((speed * 3600) / 1852 / 60) * this.options.vectorLength) / 60; // distance covered in 10 minutes
    const p0 = e.latlng;
    const p1 = L.latLng(
  ...
  smoothSpeed: (function () {
    ...
    return function (e) {
      ...
      /////////////////////////////////////////////////////////////////////////////////////////
      const v = [e.speed * cosDeg(e.heading), e.speed * sinDeg(e.heading)];
