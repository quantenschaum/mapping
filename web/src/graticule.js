...
L.LatLngGraticule = L.Layer.extend({
    ...
    onAdd: function (map) {
        ...
        if (this.options.borders) {
            ...
            css.innerHTML = `.leaflet-control-attribution { margin-bottom: ${m}px !important; margin-left: ${m}px !important; margin-right: ${m}px !important; } .leaflet-control-scale { margin-bottom: ${m + 5}px !important; margin-left: ${m + 5}px !important; }`;
