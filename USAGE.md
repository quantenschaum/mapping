...
- [Waddenzee](http://osmand.net/add-tile-source?name=Waddenzee&min_zoom=8&max_zoom=16&url_template=http://waddenzee.duckdns.org/qmap-nl/{0}/{1}/{2}.png) `http://waddenzee.duckdns.org/qmap-nl/{0}/{1}/{2}.png`
- [Germany](http://osmand.net/add-tile-source?name=Waddenzee&min_zoom=8&max_zoom=16&url_template=http://waddenzee.duckdns.org/qmap-de/{0}/{1}/{2}.png) `http://waddenzee.duckdns.org/qmap-de/{0}/{1}/{2}.png`

You can download these raster maps (`sqlitedb`) and vector depth data (`obf`) and rendering styles (`xml`) from http://waddenzee.duckdns.org/download/.
